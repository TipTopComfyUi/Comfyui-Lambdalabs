...
os.system(f"git clone -b v1.4 https://github.com/comfyanonymous/ComfyUI /home/demo/source/ComfyUI")
os.chdir(f"/home/demo/source/ComfyUI")
os.system(f"pip install -r requirements.txt")
os.system(f"git clone -b v1.4 https://github.com/ltdrdata/ComfyUI-Manager /home/demo/source/ComfyUI/custom_nodes/ComfyUI-Manager")
